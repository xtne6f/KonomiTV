...
if [ $? -eq 0 ]; then
    cpython_tgz_uri='https://github.com/indygreg/python-build-standalone/releases/download/20251031/cpython-3.11.14+20251031-aarch64-unknown-linux-gnu-install_only_stripped.tar.gz'
    cpython_sha256=ed1840fa7baa762d3506c161ee1887c29c3603737058a22639cd88ed69e4be9d
else
    cpython_tgz_uri='https://github.com/indygreg/python-build-standalone/releases/download/20251031/cpython-3.11.14+20251031-x86_64-unknown-linux-gnu-install_only_stripped.tar.gz'
    cpython_sha256=6fc38e1091600b29efb931ac77ecda9dd9b57ee19f7519e5b21042bf6eef3856
fi
...
psisimux_src_uri='https://github.com/xtne6f/psisimux/archive/1a01a38886dc41bac81d547ba31fa9eef1bad46b.tar.gz'
